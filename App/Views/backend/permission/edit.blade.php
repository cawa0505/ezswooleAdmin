    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            <form class="layui-form">
                <input type="hidden" name="permission_id" value="{{$result['permission_id']}}">
                <div class="layui-form-item">
                    <label class="layui-form-label">权限名称</label>
                    <div class="layui-input-block">
                        <input type="text" name="name" value="{{$result['name']??''}}" lay-verify="" autocomplete="off"
                               placeholder="请输入权限名称"
                               class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="url" lay-verify="" value="{{$result['url']??''}}" autocomplete="off"
                               placeholder="请输入访问地址"
                               class="layui-input">
                    </div>
                </div>
    ...
    <script>
        layui.use(['jquery', 'form'], function () {
            ...
            form.on('submit(admin)', function (data) {
                ajaxPost('/backend/permission/update', data.field, '/backend/permission/index');
                return false;
            });
            // 联动事件
