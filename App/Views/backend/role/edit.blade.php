            ...
            <form class="layui-form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="role_name" lay-verify="" value="{{$result['role_name'] ?? '' }}"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="role_desc" lay-verify="" value="{{$result['role_desc'] ?? '' }}"
                                ...
                                <dt>
                                    <div class="cate-first">
                                        ...
                                        <input type="checkbox" name="permission_id[]"
                                               @if(in_array($first['permission_id'],$result['permission_id'])) checked
                                               @endif
                                    ...
                                    @foreach($first['son'] as $second)
                                        <dd>
                                            <div class="cate-second">
                                                ...
                                                <input type="checkbox" name="permission_id[]"
                                                       @if(in_array($second['permission_id'],$result['permission_id'])) checked
                                                       @endif
                                            ...
                                            @if(isset($second['son']))
                                                <div class="cate-third">
                                                    @foreach($second['son'] as $three)
                                                        ...
                                                        <input type="checkbox" name="permission_id[]"
                                                               @if(in_array($three['permission_id'],$result['permission_id'])) checked
                                                               @endif
    ...
    <script>
        layui.use(['jquery', 'form'], function () {
            ...
            form.on('submit(admin)', function (data) {
                ajaxPost('/backend/role/update', data.field, '/backend/role/index');
                return false;
            });
        });
    </script>
