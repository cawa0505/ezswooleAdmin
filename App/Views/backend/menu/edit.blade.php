            ...
            <form class="layui-form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="menu_name" lay-verify="" value="{{$result['menu_name']}}"
                               autocomplete="off" placeholder="请输入菜单名"
                               class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="menu_url" lay-verify="" value="{{$result['menu_url']}}"
                               autocomplete="off" placeholder="请输入菜单地址"
                               class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="menu_identify" lay-verify="" value="{{$result['menu_identify'] ?? ''}}"
                               autocomplete="off" placeholder="请输入标识"
                               class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="menu_icon" lay-verify="" value="{{$result['menu_icon']  ?? ''}}"
    ...
    <script>
        layui.use(['jquery', 'form'], function () {
            ...
            form.on('submit(admin)', function (data) {
                ajaxPost('/backend/menu/update', data.field, '/backend/menu/index');
                return false;
            });
