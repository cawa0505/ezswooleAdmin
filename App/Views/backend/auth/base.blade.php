...
<head>
    <meta charset="utf-8">
    <title>@yield('title','登入 - EsAdmin')</title>
    ...
    <link rel="stylesheet" href="{{asset('static/backend/layuiadmin/style/login.css')}}" media="all">
    <style>
        body {
            background-image: url({{asset('static/backend/image/bj3.jpg')}});
        }
    </style>
</head>
<body>
