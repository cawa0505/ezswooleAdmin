    ...
    <div class="layui-layout layui-layout-admin">
        <div class="layui-header">
            ...
            <ul class="layui-nav layui-layout-left">
                ...
                <li class="layui-nav-item layui-hide-xs" lay-unselect>
                    <a href="http://dev.phpswoole.com" target="_blank" title="前台">
            ...
            <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
                ...
                <li class="layui-nav-item" lay-unselect>
                    ...
                    <dl class="layui-nav-child">
                        <dd><a lay-href="/backend/admin/info">基本资料</a></dd>
        ...
        <div class="layui-side layui-side-menu">
            <div class="layui-side-scroll">
                <div class="layui-logo" lay-href="/backend/admin/index">
                    <span>EsAdmin</span>
                </div>
                ...
                <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu"
                    ...
                    @if(!empty($menu) && !empty($permission))
                        @foreach($menu as $item)
                            <li data-name="user" class="layui-nav-item">
                                ...
                                <dl class="layui-nav-child">
                                    @if(isset($item['son']))
                                        @foreach($item['son'] as $two)
                                            @if(in_array($two['menu_url'],$permission))
                                                <dd data-name="{{$two['menu_name']}}">
                                                    <a lay-href="{{$two['menu_url']}}">{{$two['menu_name']}}</a>
                                                </dd>
                                            @endif
                                        @endforeach
                                    @endif
        ...
        <div class="layadmin-pagetabs" id="LAY_app_tabs">
            ...
            <div class="layui-tab" lay-unauto lay-allowClose="true" lay-filter="layadmin-layout-tabs">
                <ul class="layui-tab-title" id="LAY_app_tabsheader">
                    <li lay-id="/backend/index/content" lay-attr="/backend/index/content" class="layui-this"><i
        ...
        <div class="layui-body" id="LAY_app_body">
            <div class="layadmin-tabsbody-item layui-show">
                <iframe src="/backend/index/content" frameborder="0" class="layadmin-iframe"></iframe>
            </div>
        </div>
